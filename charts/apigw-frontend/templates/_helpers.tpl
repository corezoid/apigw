...
{{ .Values.image.registry }}{{ if eq .Values.global.repotype "public" }}/public{{- else }}/{{ .Values.global.repotype }}{{- end }}/apigw-apigw-frontend:{{ .Values.global.apigw.apigw_frontend.tag | default .Chart.AppVersion }}
{{- end }}
